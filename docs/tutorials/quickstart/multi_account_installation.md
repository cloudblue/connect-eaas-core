In this tutorial we will create a `Multi Account Installation` extension project using
...
* A CloudBlue Connect account


## Add the account to the Connect CLI configuration

To configure the CLI to use your account you need an API Token.
...
To create the `Multi Account Installation` extension open the Connect UI portal and navigate to the `DevOps` module:

![DevOps main](../../images/tutorials/quickstart/ma/devops_main.png)
